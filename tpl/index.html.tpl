...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" media="(prefers-color-scheme: dark)" href="/pwt/themes/theme-proxmox-dark.css?ver=[% wtversion %]" />
      ...
      [%- IF theme != 'crisp' %]
      [%- IF theme == 'auto' %]
    <link rel="stylesheet" type="text/css" media="(prefers-color-scheme: dark)" href="/pwt/themes/theme-proxmox-discord-dark.css?ver=[% wtversion %]" />
      [%- END -%]
      [%- END -%]
    ...
    <script type="text/javascript">
    const pveTheme = '[% theme %]';
    console.log('pveTheme', pveTheme == 'auto', pveTheme != 'crisp');
    // get 
    </script>
